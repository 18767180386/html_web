var actAm = function(t) {
    var e = this.opt = { type: 0, wrapper: "", box: "", active: "active", event: "hover", current: 0, auto: !1, autoTime: 5e3, interval: 0, cb: function() {} };
    $.extend(this.opt, t);
    var n = this;
    this.init = function() { $(e.wrapper).length > 1 ? $(e.wrapper).each(function(t, i) { n.eventInit($(i), $(e.box).eq(t)) }) : n.eventInit($(e.wrapper), $(e.box)) }, this.eventInit = function(t, i) {
